...
#sphinxodoo_addons = ['second_module', 'test_module']
sphinxodoo_addons = []

print('sphinxodoo_root_path=%s' % sphinxodoo_root_path)
print('sphinxodoo_addons=%s' % sphinxodoo_addons)
print('sphinxodoo_addons_path=%s' % sphinxodoo_addons_path)
